...
const MPO<Quantum> MPOGen_Hubbard_BCS::create_op(const ColumnVector& c, Spin s) const {
...
const MPO<Quantum> MPOGen_Hubbard_BCS::anni_op(const ColumnVector& c, Spin s) const {
  vector<Qshapes<Quantum>> qr;
  vector<Dshapes> dr;
  int l0 = 1, r0 = nsite;
  /*
